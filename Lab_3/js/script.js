...
class User{
    ...
    save(){
        //зберігапє налаштування + дату збереження у базу даних
        this.concreteBackup = new ConcreteBackup(this.my_settings);
        return this.concreteBackup.get_backup();
    }

    get_save(){
        //виводимо наші теперішні налаштування
        console.log(`Зараз мої налаштування такі: ${this.my_settings}`);
    }
}

//Створення нашого бекапу (Знімок)
...
user1.get_save();//показуємо їх
database.backup();//Зберігаємо їх
