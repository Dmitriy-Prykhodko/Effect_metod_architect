...
class OrderValid extends MainValid{
    ...
    //Додатковий метод який типу створює Json файл. Він же й "хук" для останнього завдання.
    generate_json(code, status){
...
let tovar1 = new Product("Proddd", 10000001, false)
...
console.log('====================================');
let user1 = new User("Stepan", 10000022, "stepan_bander@gmail.com")
...
user_valid.valid_data("Stepa", 77700022, "stepa_italy@gmail.com")
console.log(user1.get_name());
console.log(user1.get_ip());
console.log(user1.get_email());
